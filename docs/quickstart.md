...
[Shardeum Node Types](/node/types.md)
...
[Shardeum Explorer](/network/explorer.md)

## Deploy Contracts to Shardeum

Since Shardeum is EVM compatible, you can use the following frameworks to deploy to Shardeum:

[Remix IDE](/smart-contracts/deploy/remix.md)

[Foundry](/smart-contracts/deploy/foundry.md)

[Hardhat](/smart-contracts/deploy/hardhat.md)



To deploy contracts at the same address cross chain:

[Same Address Cross Chain](/smart-contracts/deploy/same-address.md)
...
[ERC-20 (Fungible Tokens)](/smart-contracts/tokens/ERC-20.md)

[ERC-721 (NFTs)](/smart-contracts/tokens/ERC-721.md)

[ERC-1155 (Token Emulator)](/smart-contracts/tokens/ERC-1155.md)
...
[EIP-2930 Overview](/smart-contracts/eip-2930/multicall-contract.md)
...
[IPFS and Filecoin](/storage/ipfs-and-filecoin.md)

## Oracles on Shardeum

Get off chain data securely on Shardeum using oracle providers.

[SupraOracles](/oracles/supraoracles.md)
